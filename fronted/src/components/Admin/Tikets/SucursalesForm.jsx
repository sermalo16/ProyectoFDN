    ...
    <>
      ...
      >
        <Row gutter={20}>
          ...
          <Col span={12}>
            <Form.Item label="Tipo Solicitud Sucursales" name="Tipo Solicitud">
              <Select defaultValue="Montaje de Nueva Sucursal">
                <Option value="Montaje de Nueva Sucursal">Montaje de Nueva Sucursal</Option>
                <Option value="Desmontaje de Sucursal">Desmontaje de Sucursal</Option>
